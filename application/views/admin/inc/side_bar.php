    <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center bg-gradient-dark justify-content-center" href="admin">
     ...
     <!--  <div class="sidebar-heading">
      ...
      <li class="nav-item">
        ...
        <div id="ammountPages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="admin/departments">Departments</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="admin/projects">Running Projects</a>
            <a class="collapse-item" href="admin/closed_projects">Closed Projects</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePagesReport" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="admin/pending_requests">Pending Requests</a>
            <a class="collapse-item" href="admin/project_work">Project Work</a>
            <a class="collapse-item" href="admin/closed_project_work">Closed Project Work</a> 
            <a class="collapse-item" href="admin/department_work">Department Wise Work</a> 
          </div>
        </div>
      </li>
