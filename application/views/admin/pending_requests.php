                  ...
                  <tbody>
                      ...
                      <?php if($input->input_type == 1) { ?>
                       <tr>
                          ...
                          <td><a href="admin/user_work/<?=$input->user_id?>"><?=$input->agent_name?></a></td>
                          <td><a href="admin/project_details/<?=$input->project_id?>"><?=$input->project_name?></a></td>
      ...
      $.confirm({
          ...
          buttons: {
            unapprove: {
              ...
              action: function () {
                $.ajax({
                    url: 'admin/input_action/' + input_id  +'/' + valu,
                    type: 'POST',
                    success: function (response) {
