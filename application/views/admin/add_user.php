            ...
            <div class="card-body">
              ...
              <form class="form-horizontal" method="post" action="admin/users">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="ud" name="user_id" placeholder="Enter Here" maxlength="15">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="password" class="form-control" id="psd" name="password" placeholder="Enter Here (Min 6 Char)" minlength="6" required>
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <button type="submit" class="btn btn-success float-right" name="addUser" value="addUser"><i class="fa fa-plus-square"></i> Add </button>
                  </div>
                </div>
              </form>
